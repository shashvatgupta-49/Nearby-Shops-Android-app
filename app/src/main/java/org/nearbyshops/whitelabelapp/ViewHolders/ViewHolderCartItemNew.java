...
import static org.nearbyshops.whitelabelapp.Utility.UtilityFunctions.refinedString;
...
public class ViewHolderCartItemNew extends RecyclerView.ViewHolder {
    ...
    public void setItem(CartItem cartItem)
    {
        ...
        if(item != null) {
            ...
            itemPrice.setText(PrefCurrency.getCurrencySymbol(context)  + String.format(" %.2f", cartItem.getRt_itemPrice()) + " per " + item.getQuantityUnit());
            ...
            itemTotal.setText("Total : " + PrefCurrency.getCurrencySymbol(context) + " "
            ...
            String imagePath = PrefGeneral.getServerURL(context)
